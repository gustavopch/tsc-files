...
// Delete a temporary config file if a process was terminated or interrupted
process.on('SIGINT', () => { fs.unlinkSync(tmpTsconfigPath); });
process.on('SIGTERM', () => { fs.unlinkSync(tmpTsconfigPath); });
