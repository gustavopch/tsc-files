...
const JSON_EXT = 'json';
const TS_BUILD_INFO_EXT = 'tsbuildinfo';

const tmpTsBuildInfoPath = tmpTsconfigPath.replace(JSON_EXT, TS_BUILD_INFO_EXT);

if (fs.existsSync(tmpTsBuildInfoPath)) {
  fs.unlinkSync(tmpTsBuildInfoPath)
}
